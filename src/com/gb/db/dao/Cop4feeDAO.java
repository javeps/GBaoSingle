...
public class Cop4feeDAO extends JdbcTemplate {
    ...
    public static String[] carrays ={"id", "unqkey", "chn", "version", "copfee", "createtime", "lasttime", "validBegtime", "validEndtime"};
    public static String coulmns = "id, unqkey, chn, version, copfee, createtime, lasttime, validBegtime, validEndtime";
    public static String coulmns2 = "unqkey, chn, version, copfee, createtime, lasttime, validBegtime, validEndtime";
    ...
    public int insert(final Cop4fee cop4fee, final String TABLENAME2) {
        ...
        try {
            cop4fee.reset();
            sql.append("INSERT INTO ").append(TABLENAME2).append(" (unqkey, chn, version, copfee, createtime, lasttime, validBegtime, validEndtime) VALUES (:unqkey, :chn, :version, :copfee, :createtime, :lasttime, :validBegtime, :validEndtime)");
    ...
    public int insert2(final Cop4fee cop4fee, final String TABLENAME2) {
        ...
        try{
            cop4fee.ustr();
            sql.append("INSERT INTO ").append(TABLENAME2).append(" (id, unqkey, chn, version, copfee, createtime, lasttime, validBegtime, validEndtime) VALUES (:id, :unqkey, :chn, :version, :copfee, :createtime, :lasttime, :validBegtime, :validEndtime)");
            Map map = super.insert(sql.toString(), cop4fee);
            return getInt(map, "GENERATED_KEY");
        } catch(Exception e) {
            log.info(e2s(e));
    ...
    public List<Cop4fee> selectAll(final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, unqkey, chn, version, copfee, createtime, lasttime, validBegtime, validEndtime FROM ").append(TABLENAME2).append(" ORDER BY id");
    ...
    public List<Cop4fee> selectIn(final List<Integer> keys, final String TABLENAME2) {
        ...
        try{
            ...
            String str = sb.toString();
            sql.append("SELECT id, unqkey, chn, version, copfee, createtime, lasttime, validBegtime, validEndtime FROM ").append(TABLENAME2).append(" WHERE id in (").append(str).append(" ) ORDER BY id");
            return super.queryForList(sql.toString(), Cop4fee.class);
        } catch(Exception e) {
            log.info(e2s(e));
            return newList();
    ...
    public List<Cop4fee> selectIn2(final List<Integer> keys, final String TABLENAME2) {
        ...
        try{
            ...
            String str = sb.toString();
            sql.append("SELECT id, unqkey, chn, version, copfee, createtime, lasttime, validBegtime, validEndtime FROM ").append(TABLENAME2).append(" WHERE id in ( :str ) ORDER BY id");
            Map params = newMap();
            params.put("str", str);
    ...
    public List<Cop4fee> selectLast(final int num, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, unqkey, chn, version, copfee, createtime, lasttime, validBegtime, validEndtime FROM ").append(TABLENAME2).append(" ORDER BY id DESC LIMIT ").append(num).append("");
            return super.queryForList(sql.toString(), Cop4fee.class);
        } catch(Exception e) {
            log.info(e2s(e));
            return newList();
    ...
    public Cop4fee last(final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, unqkey, chn, version, copfee, createtime, lasttime, validBegtime, validEndtime FROM ").append(TABLENAME2).append(" ORDER BY id DESC LIMIT 1");
    ...
    public List<Cop4fee> selectGtKeyNum(final int id, final int _num, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, unqkey, chn, version, copfee, createtime, lasttime, validBegtime, validEndtime FROM ").append(TABLENAME2).append(" WHERE id > :id ORDER BY id LIMIT ").append(_num).append("");
            Map params = newMap();
            params.put("id", id);
            return super.queryForList(sql.toString(), params, Cop4fee.class);
        } catch(Exception e) {
    ...
    public List<Cop4fee> selectGtKey(final int id, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, unqkey, chn, version, copfee, createtime, lasttime, validBegtime, validEndtime FROM ").append(TABLENAME2).append(" WHERE id > :id ORDER BY id");
            Map params = newMap();
            params.put("id", id);
            return super.queryForList(sql.toString(), params, Cop4fee.class);
        } catch(Exception e) {
    ...
    public Cop4fee selectByKey(final int id, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, unqkey, chn, version, copfee, createtime, lasttime, validBegtime, validEndtime FROM ").append(TABLENAME2).append(" WHERE id = :id");
            Map params = newMap();
            params.put("id", id);
    ...
    public Cop4fee selectByUnqkey(final String unqkey, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, unqkey, chn, version, copfee, createtime, lasttime, validBegtime, validEndtime FROM ").append(TABLENAME2).append(" WHERE unqkey = :unqkey");
            Map params = newMap();
    ...
    public List<Cop4fee> selectLikeUnqkey(final String unqkey, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, unqkey, chn, version, copfee, createtime, lasttime, validBegtime, validEndtime FROM ").append(TABLENAME2).append(" WHERE unqkey LIKE '%").append(unqkey).append("%' ORDER BY id ");
            return super.queryForList(sql.toString(), Cop4fee.class);
        } catch(Exception e) {
            log.info(e2s(e));
            return newList();
    ...
    public Cop4fee selectByChnVersion(final String chn, String version, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, unqkey, chn, version, copfee, createtime, lasttime, validBegtime, validEndtime FROM ").append(TABLENAME2).append(" WHERE chn=:chn AND version=:version");
            Map params = newMap();
            params.put("chn", chn);
    ...
    public List<Cop4fee> selectByPage(final int begin, final int num, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, unqkey, chn, version, copfee, createtime, lasttime, validBegtime, validEndtime FROM ").append(TABLENAME2).append(" ORDER BY id LIMIT ").append(begin).append(", ").append(num).append("");
            return super.queryForList(sql.toString(), Cop4fee.class);
        } catch(Exception e) {
            log.info(e2s(e));
            return newList();
    ...
    public int[] updateByKey (final List<Cop4fee> cop4fees, final String TABLENAME2) {
        ...
        try{
            if(cop4fees == null || cop4fees.isEmpty()) return new int[0];
            sql.append("UPDATE ").append(TABLENAME2).append(" SET unqkey=:unqkey, chn=:chn, version=:version, copfee=:copfee, createtime=:createtime, lasttime=:lasttime, validBegtime=:validBegtime, validEndtime=:validEndtime WHERE id=:id");
    ...
    public void createTable(final String TABLENAME2){
        try{
            String sql = "CREATE TABLE IF NOT EXISTS `${TABLENAME}` (" +
                ...
                "	`validBegtime`  DATETIME NOT NULL," +
                "	`validEndtime`  DATETIME NOT NULL," +
                "	PRIMARY KEY (`id`)," +
