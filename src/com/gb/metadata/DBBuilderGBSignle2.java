...
public class DBBuilderGBSignle2 {

	@SuppressWarnings("unchecked")
	public static void main(String[] args) throws Exception {
		// 该ds就是设计数据库的的source源
		DataSource ds = AppContext.dsDesign();
		String pkg = "com.gb.db";// DBBuilderLH2.class.getPackage().getName();
		...
		boolean batch = true;
		String clazz4AppContext = AppContext.class.getSimpleName();
	...
	static public List<String> getTables(DataSource ds) throws Exception {
		// String[] tbstrs = new String[] {"pbuff","pfriend"};
		// List<String> tbs = ListEx.toList(tbstrs);
		List<String> sqltabs = com.bowlong.sql.SqlEx.getTables(ds);
		List<String> result = sqltabs;// ListEx.intersectedT(tbs, sqltabs);
		return result;
	}
	...
	public static void InternalBuild(Connection conn, String tablename,
			...
			String clazz4AppContext) throws Exception {
		boolean sorted = true;
	...
	public static void EntityBuild(Connection conn, String tablename,
			String appContext, String pkg, boolean src, String clazz4AppContext)
			throws Exception {
