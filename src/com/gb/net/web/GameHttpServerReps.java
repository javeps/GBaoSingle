...
public class GameHttpServerReps implements Serializable {
	...
	void rnkPlayer(Channel chn, Object msg) {
		Map<String, String> map = N4HttpResp.getMapKVByMsg(msg);
		// 是否重新生成当天的排行榜
	...
	void rnkReset4Pl(Channel chn, Object msg) {
		Map<String, String> map = N4HttpResp.getMapKVByMsg(msg);
	...
	void rnkAward4Send(Channel chn, Object msg) {
		Map<String, String> map = N4HttpResp.getMapKVByMsg(msg);
		String str = MapEx.getString(map, "time");
	...
	/*** 创建排名奖励邮件 **/
	void createEmail4RnkByJsonTxt(Channel chn, Object msg) {
	...
	/*** 创建邮件 **/
	void createEmail(Channel chn, Object msg) {
		// FileUpload fup = N4HttpResp.getFileByMsg(msg);
		// byte[] buf = N4B2ByteBuf.readBuff(fup.content());
		try {
			Map<String, String> map = N4HttpResp.getMapKVByMsg(msg);
	...
	/*** 根据渠道排行 **/
	void rnk4Chn(Channel chn, Object msg) {
		// FileUpload fup = N4HttpResp.getFileByMsg(msg);
		// byte[] buf = N4B2ByteBuf.readBuff(fup.content());
		try {
			Map<String, String> map = N4HttpResp.getMapKVByMsg(msg);
	...
	void seePlByName(Channel chn, Object msg) {
		try {
			Map<String, String> map = N4HttpResp.getMapKVByMsg(msg);
	...
	/*** 是否清除日志 **/
	void isClearLog(Channel chn, Object msg) {
		// FileUpload fup = N4HttpResp.getFileByMsg(msg);
		// byte[] buf = N4B2ByteBuf.readBuff(fup.content());
		try {
			Map<String, String> map = N4HttpResp.getMapKVByMsg(msg);
	...
	/*** IOS_充值回调验证 **/
	void verify_ios_pay(Channel chn, Object msg) {
		try {
