...
public class GBSngBootstrap2 extends Svc {
	static Log log = LogFactory.getLog(GBSngBootstrap2.class);
	public static Date BEGIN = new Date(); // 开服时间

	static String NAME = "gboarpg2.game";
	static double VER = 2.0;
	...
	public static void main(String[] args) {
		...
		try {
			...
			TCP_PORT = AppContext.getGatePortTcp();
			WEB_PORT = AppContext.getGatePortWeb();
			SHUTDOWNPORT = AppContext.getGatePortShutdown();
			// ====end
