...
-- Database: `gbosng_cfg`
--
CREATE DATABASE IF NOT EXISTS `gbosng_cfg` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `gbosng_cfg`;
...
DELIMITER ;
--
-- Database: `gbosng_design`
--
CREATE DATABASE IF NOT EXISTS `gbosng_design` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `gbosng_design`;
